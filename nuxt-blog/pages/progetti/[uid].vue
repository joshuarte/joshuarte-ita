<template>
  ...
  <div v-else class="error container">
    ...
    <NuxtLink to="/progetti" class="btn">Torna ai progetti</NuxtLink>
  </div>
</template>
...
const { data: post, pending, error } = useAsyncData(`projects-${uid}`, async () => {
  try {
    // Ottieni solo dal tipo projects (blog_post non esiste)
    return await prismic.client.getByUID('projects', uid);
  } catch (e) {
